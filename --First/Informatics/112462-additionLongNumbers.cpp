...
void SUM_long_num (long *first_int, long*second_int, long *result);
...
int main () 
{
    ...
    SUM_long_num(first, second, result);
...
void SUM_long_num (long *first, long*second, long *result)
{
